...
const Footer = () => {
  return (
          ...
          <Row>
            ...
            <Col sm={12} md={6} lg={4}>
              ...
              <ul className="information">
                ...
                <li>
                  <a href="/home">All About EkhonEshop</a>
                </li>
                <li>
            ...
            <Col sm={12} md={6} lg={4}>
              ...
              <ul className="information contact-info">
                ...
                <li>
                  ...
                  Email: info@ekhoneshop.bd
                </li>
                <li>
                  <i className="fas fa-phone"></i>
                  Helpline: +8801771917392
                </li>
              </ul>
            </Col>
          </Row>
    ...
    //   <Container>
    //     <Row>
    //       <Col className="text-center py-3">Copyright &copy; EKHONESHOP</Col>
    //     </Row>
    //   </Container>
    // </footer>
  );
